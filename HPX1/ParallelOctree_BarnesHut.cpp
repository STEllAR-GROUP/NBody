    ...
    for(int i=1; i<9; ++i){
        ...
        if(cell[p+i].members.size()>th){
            ...
            if(cell.size()<(p+i)*8+9)
                for(int k=cell.size(); k<(p+i)*8+100000; ++k)
...
std::vector<double> compute_step2(int parent, int node, int i, double a1, double a2, double a3, double a6, double a7, double a8, double a9, double a10, double a11){
    ...
    for(int j=0; j<3; ++j)
        out.push_back((body[node].r1[j],body[cell[parent].list_cell1[i]].r1[j])*(a1*a2*a3)/pow((2.5+pow((a6-a7),2.0)+pow((a8-a9),2.0)+pow((a10-a11),2.0)),1.5));
...
std::vector<double> compute_step5(int parent, int node, int i, double a1, double a2, double a3, double a6, double a7, double a8, double a9, double a10, double a11){
    ...
    for(int j=0; j<3; ++j)
        out.push_back((body[node].r1[j]-cell[cell[parent].list_cell2[i]].r2[j])*(a1*a2*a3)/pow((2.5+pow((a6-a7),2.0)+pow((a8-a9),2.0)+pow((a10-a11),2.0)),1.5));
...
void compute2(int node){
    ...
    std::vector<double> f1(3, 0), f2(3, 0),x(3,0);
